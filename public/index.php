...
<head>
  ...
  <meta property="og:image" content="/assets/images/og-ACW.webp" />
  <!-- Twitter -->
  ...
  <meta property="twitter:image" content="/assets/images/og-ACW.webp" />
    ...
    <div class="header-l">
      ...
      <div class="hero">
        <div class="block__hero">
          <div class="hero__img">
            <img src="/assets/images/Alex-Alpha-350px.webp" width="250px" height="350px" alt="Alexandre Foulc développeur web">
          </div>
